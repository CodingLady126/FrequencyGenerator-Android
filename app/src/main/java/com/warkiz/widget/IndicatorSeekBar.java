...
import com.alexey.tonegenerator.R;
...
public class IndicatorSeekBar extends View {
    ...
    private static final String FORMAT_PROGRESS_DOWN = "${MAX-PROGRESS}";
    ...
    String getIndicatorTextString() {
        ...
        } else if (mIndicatorTextFormat != null && mIndicatorTextFormat.contains(FORMAT_PROGRESS_DOWN)) {
            return mIndicatorTextFormat.replace(FORMAT_PROGRESS_DOWN, getProgressString(mMax-mProgress));
